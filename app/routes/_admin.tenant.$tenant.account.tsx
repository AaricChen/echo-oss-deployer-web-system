...
import EntityTable2 from "~/components/entity/EntityTable";
              ...
              return [
                  ...
                  render: () => ({
                    ...
                    columns: [
                      ...
                      },
                      {
                        ...
                        convertValue: (value: RoleResponse[] | string[]) => {
                          return value.map((v) => {
                            if (typeof v === "string") {
                              return v;
                            } else {
                        ...
                        transform: (value: RoleResponse[] | string[]) => {
                          return {
                ...
                },
                {
                  ...
                  render: () => ({
                    name: "分配部门",
                    suffix: "/department",
                    permission: "system.account-update:department",
                    initialValues: entity,
                    buttonProps: {
                      type: "link",
                    },
                    columns: [
                      ...
                      },
                      {
                        ...
                        convertValue: (
                          value: DepartmentResponse[] | string[],
                        ) => {
                          return value.map((v) => {
                            if (typeof v === "string") {
                              return v;
                        ...
                        transform: (value: DepartmentResponse[] | string[]) => {
                          return {
